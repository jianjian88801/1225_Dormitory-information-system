<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开始日期" prop="kaishiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaishiriqi" 
                type="date"
                placeholder="开始日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaishiriqi" label="开始日期" prop="kaishiriqi">
              <el-input v-model="ruleForm.kaishiriqi" 
                placeholder="开始日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="留校天数" prop="liuxiaotianshu">
          <el-input v-model="ruleForm.liuxiaotianshu" 
              placeholder="留校天数" clearable  :readonly="ro.liuxiaotianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="留校天数" prop="liuxiaotianshu">
              <el-input v-model="ruleForm.liuxiaotianshu" 
                placeholder="留校天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="留校理由" prop="liuxiaoliyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="留校理由"
                  v-model="ruleForm.liuxiaoliyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.liuxiaoliyou" label="留校理由" prop="liuxiaoliyou">
                    <span>{{ruleForm.liuxiaoliyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.sushehao = true;
          ...
          if(o=='liuxiaoliyou'){
            this.ruleForm.liuxiaoliyou = obj[o];
	    this.ro.liuxiaoliyou = true;
            continue;
          }
          if(o=='kaishiriqi'){
            this.ruleForm.kaishiriqi = obj[o];
	    this.ro.kaishiriqi = true;
            continue;
          }
          if(o=='liuxiaotianshu'){
            this.ruleForm.liuxiaotianshu = obj[o];
	    this.ro.liuxiaotianshu = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiaqiliusu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaqiliusuCrossAddOrUpdateFlag = false;
                  this.parent.search();
