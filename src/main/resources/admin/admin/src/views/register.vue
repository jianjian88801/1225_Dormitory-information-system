  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">学生宿舍信息的系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">宿舍号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.sushehao" class="input" type="text" placeholder="宿舍号">
			   </div>
			 </div> -->
			<el-form-item label="宿舍号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.sushehao" autocomplete="off" placeholder="宿舍号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='weixiurenyuan'" class="input-group">
			   <div class="label">维修工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.weixiugonghao" class="input" type="text" placeholder="维修工号">
			   </div>
			 </div> -->
			<el-form-item label="维修工号" class="input" v-if="tableName=='weixiurenyuan'">
			  <el-input v-model="ruleForm.weixiugonghao" autocomplete="off" placeholder="维修工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='weixiurenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='weixiurenyuan'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='weixiurenyuan'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='shangjia'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.weixiugonghao) && `weixiurenyuan` == this.tableName){
      ...
      if((!this.ruleForm.xingming) && `weixiurenyuan` == this.tableName){
      ...
      if(`weixiurenyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
